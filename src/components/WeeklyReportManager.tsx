      ...
      const mockReports: WeeklyReportData[] = [
        {
          ...
          attempts: [
            { category: 'Tangrams', level: 'Level 1', attempt: 2, points: 200, date: selectedWeek },
            { category: 'Tangrams', level: 'Level 2', attempt: 1, points: 300, date: selectedWeek },
        ...
        },
        {
          ...
          weekEnd: new Date(new Date(selectedWeek).getTime() + 6 * 24 * 60 * 60 * 1000).toISOString().split('T')[0],
          attempts: [
            { category: 'Tangrams', level: 'Level 1', attempt: 1, points: 300, date: selectedWeek },
